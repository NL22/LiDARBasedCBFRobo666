...
class SafetyNN(nn.Module):
    ...
    def forward(self, x, alpha):
        ...
        x = torch.cat([x, alpha.unsqueeze(1)], dim=1)
...
class SafetyNet():
    def __init__(self, min_d_sample=0.1, iter_mem=50, grid_size_plot=0.1, dh_dt=0.01, smoothing_window = 5):
        ...
        self.model.load_state_dict(torch.load('/home/jesse/LiDARBasedCBFRobo666/lidar_gp_cbf/safety_nn_model_alpha_full.pth'))
